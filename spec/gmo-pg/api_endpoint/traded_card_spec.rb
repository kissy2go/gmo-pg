...
RSpec.describe GMO::PG::TradedCard, type: :api_endpoint do
  it_behaves_like 'an API Endpoint', '/payment/TradedCard.idPass'
end

RSpec.describe GMO::PG::TradedCard::Request, type: :request do
...
RSpec.describe GMO::PG::TradedCard::Response, type: :response do
